...
@interface HomeCricleWebViewController ()<WKNavigationDelegate>
@property (nonatomic, strong) UIProgressView *myProgressView;

@property (nonatomic, strong) WKWebView *myWebView;
@end

@implementation HomeCricleWebViewController
- (void)viewDidLoad
{
    [super viewDidLoad];
    self.title = @"圈子详情";
    ...
    [self.myWebView loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/moments/detail?token=%@&id=%@",HostUrl,[UserModel sharedInstance].token,self.urlID]]]];
...
//    [super viewDidLoad];
//    self.view.backgroundColor = [UIColor whiteColor];
//    [self initliazWebView];
//}
//-(void)initliazWebView{
//    UIWebView *web = [[UIWebView alloc]initWithFrame:self.view.bounds];
//    [web loadRequest:[NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@/moments/detail?token=%@&id=%@",HostUrl,[UserModel sharedInstance].token,self.urlID]]]];
