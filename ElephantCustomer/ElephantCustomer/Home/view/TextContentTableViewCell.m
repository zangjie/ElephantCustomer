...
@implementation TextContentTableViewCell
...
-(void)initliazView{
    self.textContent= [UITextView new];
//    self.textContent.placeholder = @"项目名称";
    self.textContent.font = mFont(15);
    self.textContent.textColor = darkGrayTextColor;
